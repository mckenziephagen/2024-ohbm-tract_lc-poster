...
- Processed into "tract profiles"[@Kruper2021-az] (9,600 features) using [pyAFQ](https://yeatmanlab.github.io/pyAFQ/) and "local connectome fingerprint" (128,894 features) using DSI-Studio [@Yeh2016-hv] (shared by [@Rasero2021-ef]). 
...
- Additional models were ran without group cross-validation.


<div style="text-align: center; transform: translate(0px,-100px); padding: 0px;">
![](images/ohbm_methods1.png){#id .class width=75% height=50%}
</div>


# Conclusions
- Phenotypes vary in their ability to be predicted from features derived from imaging data. 
