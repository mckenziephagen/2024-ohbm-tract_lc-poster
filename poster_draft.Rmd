...
- Models evaluated with and without assigning related individuals to the same fold to evaluate "leakage".


<div style="text-align: center; transform: translate(0px,-100px); padding: 0px;">
![](images/ohbm_methods1.png){#id .class width=100% height=100%}
</div>
...
.ref {place-content: center; margin: 0px;padding: 0px; position: absolute;  translate(0px,-95px);
